...
複数のアルカナ効果が同時に発動できる場合、数字の小さい順番に、スート効果を優先して解決します。

複数のカードが条件を満たしていても、同じ効果は1ターンに1回しか発動できません。

例: 魔術師(スペード1)と女教皇(ハート2)と女帝(ダイヤ3)を所持、ハート1とダイヤ1を場に出す場合
1. ダイヤ1は魔術師のナンバーと同じ → 魔術師のナンバー効果を発動
2. ハート1は魔術師のナンバーと同じだが不発 すでに魔術師のナンバー効果を発動しているため
3. ハート1は女教皇のスートと同じ → 女教皇のスート効果を発動
4. ダイヤ1は女帝のスートと同じ → 女帝のスート効果を発動
