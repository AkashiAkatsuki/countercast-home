...
強力な攻撃を通すには「カウンターキャスト」が有効です。完璧な防御をして、不可避のカウンター攻撃をお見舞いしましょう。
...
| ♥2 | 女教皇 | クイックリロード | 山札の上1枚を裏向きでチャージ |
| ♦3 | 女帝 | 治癒1 | リロード ドロー1 |
| ♣4 | 皇帝 | 各プレイヤーにドロー1 | 相手は手札をランダムに2枚捨てる |
| ♠5 | 教皇 | 攻撃成功ならドロー1 | ダメージ5 |
| ♥6 | 恋人 | 治癒2 | 各プレイヤーにリロード |
| ♦7 | 戦車 | クイックリロード | 山札の上1枚をチャージ |
| ♣8 | 力 | ダメージ2 | ドロー3 |
| ♠9 | 隠者 | ダメージ3 | 相手は手札を公開する |
| ♥10 | 運命の輪 | リロード | 相手にリロード |
| ♦11 | 正義 | ランダムな手札1枚をチャージ | リロード 治癒3 |
...
手札をすべて捨て、山札からカードを5枚引きます。

### クイックリロード

手札をすべて捨て、山札から捨てた枚数分のカードを引きます。

### チャージ

指定されたカードを表向きでアルカナの下に置きます。次の攻撃ターンに、それを追加の攻撃カードとして場に出します。
